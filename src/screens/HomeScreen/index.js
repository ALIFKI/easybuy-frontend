  ...
  constructor() {
    ...
    this.state = {
      data: [
        {
          imageUrl:
            'https://images-na.ssl-images-amazon.com/images/I/51gHME-uBsL._AC_.jpg',
          title: 'something',
        },
        {
          imageUrl:
        ...
        {
          imageUrl:
            'https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1590471773/ymv145q4thcorvgt0i5u.jpg',
          title: 'something',
        },
        {
          imageUrl:
